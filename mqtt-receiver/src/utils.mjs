...
export const isValidUserName = (name) => {
  ...
  // Разрешаем: буквы (включая кириллицу и международные), цифры, пробелы,
  // дефисы, подчеркивания, точки, скобки, квадратные скобки, @, |, /, запятые, эмоджи
  // Включаем модификаторы эмоджи (код 65039) и другие Unicode символы
