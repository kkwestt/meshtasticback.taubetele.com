...
export const servers = [
  ...
  },
  {
    ...
    // topics: ["msh/RU/#"], // или ["msh/RU/MSK/#"]  если нужно, это опция!!!
  },
  ...
  //   type: "mqtt",
  // },
  // ONEmesh.ru - требует кастомных топиков (не используйте wildcard +)
  // Для получения данных со всей России используйте: ["msh/RU/#"]
  // Для конкретного города (например, Москва): ["msh/RU/MSK/#"]
  // Список кодов городов: https://map.onemesh.ru/city-topics.html
  // {
  //   address: "mqtt://mqtt.onemesh.ru:1883",
  //   name: "mqtt.onemesh.ru",
  //   type: "mqtt",
  //   telegram: true,
  //   topics: ["msh/RU/#"], // Укажите нужные топики здесь
  // },
];
